...
export class AvailableRootsRegistryContractProd implements AvailableRootsRegistryContract {
  private contract;
...
export class AvailableRootsRegistryContractMock implements AvailableRootsRegistryContract {
