...
export class CommitmentMapperRegistryContractDev
  implements CommitmentMapperRegistryContract
{
  ...
  public async getCommitmentMapperPubKey(): Promise<[BigNumber, BigNumber]> {
    return [BigNumber.from(this._pubKeyX), BigNumber.from(this._pubKeyY)]
  }
}
